...
function StartVidyoConnector(VC, webrtc) {
    ...
    VC.CreateVidyoConnector({
        ...
        var fixedParticipantConfig = configParams.enableCompositorFixedParticipants;
        if (fixedParticipantConfig) {
            vidyoConnector.SetAdvancedConfiguration({ enableCompositorFixedParticipants: fixedParticipantConfig == 'true' ? true : false });
            console.log("Fixed composite participant configuration set to = " + fixedParticipantConfig);
        }
...
function registerDeviceListeners(vidyoConnector, cameras, microphones, speakers) {
    ...
    vidyoConnector.RegisterLocalCameraEventListener({
        ...
        onSelected: function(localCamera) {
            ...
            var maxWidth = getUrlParameterByName("maxConstraintWidth");
            var maxHeight = getUrlParameterByName("maxConstraintHeight");
            var maxFps = getUrlParameterByName("maxConstraintFps");

            if (maxWidth != null && maxHeight != null && maxFps != null) {
...
function parseUrlParameters(configParams) {
    ...
    configParams.enableCompositorFixedParticipants = getUrlParameterByName("enableCompositorFixedParticipants");
